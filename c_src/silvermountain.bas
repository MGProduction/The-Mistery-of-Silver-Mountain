...
90 FOR I=1 TO G-1
100 READ O$
120 IF F(I)=0 AND C(I)=R THEN GOSUB 4900
130 NEXT I
...
230 FOR I=1 TO LEN (E$(R)): IF E$(R,I)<>" " THEN PRINT E$(R,I);",";
...
360 U$=V$( TO 3)
370 FOR I=1 TO NV: IF B$(I*3-2 TO I*3)=U$ THEN VB=I: I=NV
380 NEXT I: F(36)=0
390 GOSUB 3330
...
460 IF VB>NV THEN R$="TRY SOMETHING ELSE"
470 IF VB>NV AND B=0 THEN R$="YOU CANNOT "+I$
...
510 IF R=56 AND F(35)=0 AND VB<>37 AND VB<>53 THEN R$="THE GHOST OF THE GOBLIN GUARDIAN"+" HAS GOT YOU!": GOTO 30
520 IF VB=44 OR VB=47 OR VB=19 OR VB=57 OR VB=49 THEN GOTO 540
530 IF R=48 AND F(63)=0 THEN R$="THE WIZARD HAS YOU IN HIS GLARE": GOTO 30
540 H=VAL (STR$ (R)+STR$ (B))
550 GOSUB X(VB)
630 GOTO 650
650 IF F(62)=1 THEN GOTO 730
660 IF R=41 THEN F(67)=F(67)+1: IF F(67)=10 THEN F(56)=1: R$="YOU SANK!"
670 IF R=56 AND F(35)=0 AND C(10)<>0 THEN R$="THE GHOST OF THE GOBLIN GUARDIAN"+" GETS YOU!": F(56)=1
...
890 IF R=73 OR R=42 OR R=9 OR R=10 THEN R$="A GRARG PATROL APPROACHES": F(55)=1: RETURN 
...
950 IF ((R=3 AND D=2) OR (R=4 AND D=4)) AND F(45)=0 THEN R$="A PILE OF RUBBLE BLOCKS YOUR PATH": RETURN 
...
1000 IF (R=38 OR R=37) AND F(50)=0 THEN R$="JU JT UPP EBSL": GOSUB 4260: RETURN 
...
1040 IF R=58 AND (D=1 OR D=4) AND F(66)=0 THEN R$="YOU GET CAUGHT IN THE COBWEBS!": RETURN 
...
1670 IF R=49 THEN R$="VERY INTERSTING!"
...
1820 IF H=2228 AND C(5)=81 THEN R$="HE LEADS YOU "+"NORTH": C(28)=81: R=12
1830 IF (H=2228 AND C(5)=0) OR H=225 THEN R$="HE LEADS YOU "+"NORTH": R=12
1840 IF (H=1228 AND C(5)=0) OR H=125 THEN R$="HE LEADS YOU "+"SOUTH": R=22
1850 IF H=385 OR H=3824 THEN R$="THEY SCURRY AWAY": C(B)=81: F(65)=1
1860 IF H=711 THEN F(46)=1: R$="HE IS DISTRACTED"
1865 IF B=0 OR B>G THEN RETURN 
1870 IF R=7 OR R=33 THEN R$="HE EATS IT!": C(B)=81
1880 RETURN 
1890 R$="YOU SAID IT"
1900 IF B=84 THEN R$="YOU MUST SAY THEM ONE BY ONE!": RETURN 
1910 IF R<>47 OR B<71 OR B>75 OR C(27)<>0 THEN RETURN 
1920 IF B=71 AND F(60)=0 THEN R$="THE MOUNTAIN RUMBLES!": F(60)=1: RETURN 
1930 IF B=72 AND F(60)=1 AND F(61)=0 THEN R$="TOWERS FALL DOWN!": F(61)=1: RETURN 
1940 IF B=(F(52)+73) AND F(60)=1 AND F(61)=1 THEN F(62)=1: RETURN 
1950 R$="THE WRONG SACRED WORD!": F(56)=1: RETURN 
1960 IF B=5 OR B=10 OR B=28 THEN GOSUB 1290
1970 RETURN 
...
2410 RETURN 
2420 IF B<>22 OR R<>15 THEN R$="DO NOT GROW!": RETURN 
2430 R$="OK": F(37)=1
2440 RETURN 
2450 IF B=22 AND F(37)=1 AND F(34)=1 THEN R$="B MBSHF WJOF HSPXT JO TFDPOET!": F(38)=1: GOSUB 4260
2460 RETURN 
2470 IF B=7 OR B=18 THEN R$="THWACK!"
2480 IF H=5818 THEN R$="YOU CLEARED THE COBWEBS": F(66)=1
...
2560 IF R=36 THEN R$="YOU FOND SOMETHING": F(13)=0
2570 RETURN 
...
2900 IF H=5610 THEN F(35)=1: R$="THE GHOST OF THE GOBLIN GUARDIAN IS FREE": E$(56)="NS"
2910 RETURN 
...
3060 RETURN 
3070 IF (H=4864 OR H=4819) AND C(19)=0 THEN R$="ZPV SFGMFDUFE UIF XJABSE'T HMBSF! IF JT EFBE": F(63)=1: GOSUB 4260
...
3370 INPUT Z$: RETURN 
3380 DIM C(G): DIM E$(80,4): DIM F(70): DIM X$(6,4): DIM Y$(6,7): DIM G$(2,8): DIM X(NV+1)
3390 GOSUB 3330
...
4490 F(44)=4: F(57)=68: F(58)=54: F(59)=15: F(52)=INT (RND*3)
4500 R=77: R$="GOOD LUCK ON YOUR QUEST!"
4510 G$(1)="": FOR I=1 TO 8
4520 F$=B$(1+INT (RND*4)*3)
...
4710 LOAD F$+"(C)" DATA C()
4720 LOAD F$+"(F)" DATA F()
4730 LOAD F$+"(G$)" DATA G$()
4740 RETURN 
4750 REM SAVE DATA FILE
4760 REM 
4780 SAVE F$+"(E$)" DATA E$()
4790 SAVE F$+"(C)" DATA C()
4800 SAVE F$+"(F)" DATA F()
...
4920 J$=J$+" "+P$+" "+O$+","
4930 RETURN 
5000 RESTORE 6000: FOR I=1 TO NV+1
